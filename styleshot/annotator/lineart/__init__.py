...
class LineartDetector:
    def __init__(self,annotator_ckpts_path):
        self.model = self.load_model(annotator_ckpts_path,'sk_model.pth')
        self.model_coarse = self.load_model(annotator_ckpts_path,'sk_model2.pth')

    def load_model(self,annotator_ckpts_path, name):
